    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if form.cleaned_data["accept_terms"] == False:
                ...
                databaseInput = GoodApply(age=form.cleaned_data["age"], gender=form.cleaned_data["gender"], country=form.cleaned_data["country"], seek_help=form.cleaned_data["seek_help"], tech_company=form.cleaned_data["tech_company"], remote_work=form.cleaned_data["remote_work"])
                #databaseInput.save()
            print(form.cleaned_data)

            prediction = model.predict_good(form.cleaned_data["age"], form.cleaned_data["gender"], form.cleaned_data["country"], form.cleaned_data["seek_help"], form.cleaned_data["tech_company"], form.cleaned_data["remote_work"])
            #do prediction here
